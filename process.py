...
all_files = os.path.join("competition_data","train", "*")
dot_files = os.path.join("competition_data","train","*.*")
directory_names = list(set(glob.glob(all_files)).difference(set(glob.glob(dot_files))))
...
print regionmax.minor_axis_length
print regionmax.major_axis_length
...
mclogloss = multiclass_log_loss(y, y_pred)
print mclogloss
